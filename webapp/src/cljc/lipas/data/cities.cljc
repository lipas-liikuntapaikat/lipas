...
(def avi-areas
  {1
   {:name {:fi "Etelä-Suomen AVI", :en "Etelä-Suomen AVI", :se "Södra Finland"},
    :provinces #{7 1 9 5 8}},
   2
   {:name
    {:fi "Lounais-Suomen AVI",
     :en "Lounais-Suomen AVI",
     :se "Sydvästra Finland"},
    :provinces #{4 2}},
   3
   {:name {:fi "Itä-Suomen AVI", :en "Itä-Suomen AVI", :se "Östra Finland"},
    :provinces #{12 11 10}},
   4
   {:name
    {:fi "Länsi- ja Sisä-Suomen AVI",
     :en "Länsi- ja Sisä-Suomen AVI",
     :se "Västra och Inre Finland"},
    :provinces #{15 13 6 14 16}},
   5
   {:name
    {:fi "Pohjois-Suomen AVI", :en "Pohjois-Suomen AVI", :se "Norra Finland"},
    :provinces #{17 18}},
   6
...
;; 19 Provinces
;; https://www.tilastokeskus.fi/meta/luokitukset/maakunta/001-2019/index.html
(def provinces
  {7
   {:name
    {:fi "Päijät-Häme", :en "Päijät-Häme", :se "Päijänne-Tavastland"}},
   1 {:name {:fi "Uusimaa", :en "Uusimaa", :se "Nyland"}},
   4 {:name {:fi "Satakunta", :en "Satakunta", :se "Satakunta"}},
   15 {:name {:fi "Pohjanmaa", :en "Pohjanmaa", :se "Österbotten"}},
   21 {:name {:fi "Ahvenanmaa", :en "Ahvenanmaa", :se "Åland"}},
   13
   {:name
    {:fi "Keski-Suomi", :en "Keski-Suomi", :se "Mellersta Finland"}},
   6 {:name {:fi "Pirkanmaa", :en "Pirkanmaa", :se "Birkaland"}},
   17
   {:name
    {:fi "Pohjois-Pohjanmaa",
     :en "Pohjois-Pohjanmaa",
     :se "Norra Österbotten"}},
   12
   {:name
    {:fi "Pohjois-Karjala",
     :en "Pohjois-Karjala",
   ...
   {:name
    {:fi "Varsinais-Suomi",
     :en "Varsinais-Suomi",
     :se "Egentliga Finland"}},
   19 {:name {:fi "Lappi", :en "Lappi", :se "Lappland"}},
   11
   {:name
    {:fi "Pohjois-Savo", :en "Pohjois-Savo", :se "Norra Savolax"}},
   9
   {:name
    {:fi "Etelä-Karjala", :en "Etelä-Karjala", :se "Södra Karelen"}},
   5
   {:name
    {:fi "Kanta-Häme", :en "Kanta-Häme", :se "Egentliga Tavastland"}},
   14
   {:name
    {:fi "Etelä-Pohjanmaa",
     :en "Etelä-Pohjanmaa",
     :se "Södra Österbotten"}},
   16
   {:name
    {:fi "Keski-Pohjanmaa",
     :en "Keski-Pohjanmaa",
     :se "Mellersta Österbotten"}},
   10
   {:name {:fi "Etelä-Savo", :en "Etelä-Savo", :se "Södra Savolax"}},
   18 {:name {:fi "Kainuu", :en "Kainuu", :se "Kajanaland"}},
   8 {:name {:fi "Kymenlaakso", :en "Kymenlaakso", :se "Kymmenedalen"}}})
...
(def all
  [{:name {:fi "Alahärmä", :se "Alahärmä", :en "Alahärmä"},
   ...
   {:name {:fi "Lappajärvi", :se "Lappajärvi", :en "Lappajärvi"},
    ...
    :avi-id 4}
   {:name
    {:fi "Lappeenranta", :se "Villmanstrand", :en "Lappeenranta"},
    :city-code 405,
    :status "active",
    :valid-until nil,
    :province-id 9,
   ...
   {:name {:fi "Mikkeli", :se "S t Michel", :en "Mikkeli"},
    ...
    :avi-id 3}
   {:name
    {:fi "Mikkelin mlk", :se "S t Michels lk", :en "Mikkelin mlk"},
    :city-code 492,
    :status "abolished",
    :valid-until 2001,
    :province-id 10,
   ...
   {:name {:fi "Mäntyharju", :se "Mäntyharju", :en "Mäntyharju"},
    ...
    :avi-id 3}
   {:name
    {:fi "Mänttä-Vilppula", :se "Vilppula", :en "Mänttä-Vilppula"},
    :city-code 508,
    :status "active",
    :valid-until nil,
    :province-id 6,
   ...
   {:name {:fi "Värtsilä", :se "Värtsilä", :en "Värtsilä"},
    ...
    :avi-id 3}
   {:name
    {:fi "Vöyri (-2006)", :se "Vörå (-2006)", :en "Vöyri (-2006)"},
    :city-code 944,
    :status "abolished",
    :valid-until 2007,
    :province-id 15,
    :avi-id 4}
   {:name
    {:fi "Vöyri-Maksamaa", :se "Vörå-Maxmo", :en "Vöyri-Maksamaa"},
    :city-code 945,
    :status "abolished",
    :valid-until 2011,
    :province-id 15,
