...
(def segment-reference-schema
  "Schema for a single segment reference with direction information"
  [:map
   [:fid [:string]]
    ...
    {:schema [:sequential
              (mu/merge
               ...
               [:map
                ...
                [:segments {:optional true} [:sequential segment-reference-schema]]
                [:ordering-method {:optional true} [:enum "manual" "algorithmic"]]
