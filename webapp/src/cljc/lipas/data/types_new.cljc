  ...
  {1530
   ...
   {:description
    {:fi
     ...
     :se
     "En eller flera tennisbanor inom samma område. Antal banor, underlag med mera specificeras i egenskaperna, inklusive informationn om eventuell slagvägg.",
     :en
   ...
   {:description
    {:fi
     ...
     :se
     "Plan för boboll, kan inkludera läktare. Ska kunna användas för spel på minst nationell nivå. Underlag av sand, konstgräs eller annat syntetiskt material. Minst 50 x 100 meter.",
     :en
   ...
   {:description
    {:fi
     ...
     :se
     "En idrottssal som är ansluten till en annan byggnad. Storlek och höjd anges under ytterligare information.",
     :en
   ...
   {:description
    {:fi
     ...
     :se
     "En anläggning med idrottstjänster i vattenmiljö eller en servicehelhet som kan bestå av olika aktivitetsplatser eller banor på eller i vattnet.",
     :en
     "Water sports center offers water-based sports services or a service complex that can consist of various performance venues or tracks on or in the water."},
    :tags {:fi []},
    :name
    {:fi "Vesiurheilukeskus",
     :se "Vattensportscentrum",
     :en "Water sports center"},
    :type-code 3250,
    :main-category 3000,
    :status "active",
    :sub-category 3200,
   ...
   {:description
    {:fi
     ...
     :se
     "Märkt berg i naturen. Isklättring i tilläggsinformationn. Även berg för bouldering.",
     :en
   ...
   {:description
    {:fi
     ...
     :se
     "En byggd eldningsplats eller ett kokskjul. Objektet kan till exempel vara en eldstad med tak som är isolerad från marken eller en eldstad för öppen eld. En mer detaljerad beskrivning av eldningsplatsen och informationn om eventuella begränsningar finns under ytterligare information.",
     :en
   ...
   {:description
    {:fi
     ...
     :se
     "Ute eller inne. Utrustning och grenar under ytterligare information.",
     :en
   ...
   {:description
    {:fi
     ...
     :se
     "Led avsedd för ridning och/eller häst med kärra. Användningsanvisningar under ytterligare information.",
     :en
   ...
   {:description
    {:fi
     ...
     :se
     "Biljardhall är ett utrymme avsett för biljardspel. Antalet och typen av biljardbord beskrivs under ytterligare information.",
     :en
     "Billiard hall is a facility designed for playing billiards. The number and type of billiard tables are specified in the additional information."},
    :tags {:fi []},
   ...
   {:description
    {:fi
     ...
     :se
     "Antalet banor och serviceutrustning under ytterligare information.",
   ...
   {:description
    {:fi
     ...
     :se "Antalet banor under ytterligare information.",
   ...
   {:description
    {:fi
     ...
     :se
     "Sal där man kan utöva självförsvarsgrenar, t ex brottning, boxning. Storleken anges under ytterligare information.",
     :en
   ...
   {:description
    {:fi
     ...
     :se
     "Hall avsedd för fotboll. Ytmaterial, antalet planer och storlek under ytterligare information.",
     :en
   ...
   {:description
    {:fi
     ...
     :se
     "En utomhusbana som är mekaniskt eller artificiellt kyld. informationn om banans storlek och utrustning finns under ytterligare information. Används under vintersäsongen.",
     :en
   ...
   {:description
    {:fi
     ...
     :se
     "Inomhuslek-/aktivitetspark är en fysiskt aktiverande anläggning som är avsedd för både små barn och ungdomar, med olika typer av lek- och aktivitetsmöjligheter.",
     :en
     "Indoor playground/activity park is a physically activating facility designed for both young children and youth, featuring various play and activity opportunities."},
    :tags {:fi []},
    :name
    {:fi "Sisäleikki-/sisäaktiviteettipuisto",
     :se "Inomhuslek-/aktivitetspark",
     :en "Indoor playground/activity park"},
    :type-code 2225,
    :main-category 2000,
    :status "active",
    :sub-category 2200,
   ...
   {:description
    {:fi
     ...
     :se
     "Läktare finns, storleken på läktaren anges under ytterligare information, likaså antalet planer.",
     :en
    ...
    {:surface-material {:priority 79},
     ...
     :may-be-shown-in-harrastuspassi-fi? {:priority 0},
     :ice-rinks-count {:priority 80},
     :field-2-flexible-rink? {:priority 85},
     :toilet? {:priority 70},
     :area-m2 {:priority 90},
     ...
     :field-1-flexible-rink? {:priority 87},
     :loudspeakers? {:priority 70},
     :school-use? {:priority 40},
     :field-3-flexible-rink? {:priority 82}}},
   4710
   {:description
    {:fi
     ...
     :se
     "Byggd klättervägg utomhus, klätterbana eller annan plats byggd för klättring. Även platser för bouldering. Precisering under ytterligare information.",
     :en
   ...
   {:description
    {:fi
     ...
     :se
     "Gymredskap osv. Storleken anges under ytterligare information.",
   ...
   {:description
    {:fi
     ...
     :se
     "Officiell golfbana. Antal hål anges under ytterligare informationn.",
     :en
   ...
   {:description
    {:fi "Katettu laskettelurinne.",
     :se
     "Slalombacke med tak. Höjdskillnad och längd under ytterligare information.",
     :en
   ...
   {:description
    {:fi
     ...
     :se
     "En eller flera squashplaner. Antalet planer under ytterligare information.",
     :en
   ...
   {:description
    {:fi
     ...
     :se
     "Fristående, ej i anslutning till en friidrottshall. Övningsplatserna anges under ytterligare information.",
     :en
   ...
   {:description
    {:fi "Ratsastukseen varustettu kenttä.",
     :se
     "Bana avsedd för ridning. Storlek under ytterligare information.",
     :en
   ...
   {:description
    {:fi
     ...
     :se
     "Utrustad för tyngdlyftning och boxning. Storleken anges under ytterligare information.",
     :en
   ...
   {:description
    {:fi
     ...
     :se "Stor motoranläggning för formelbilsracing.",
   ...
   {:description
    {:fi "Lumilautailua varten rakennettu halli.",
     :se
     "Tunnel avsedd för snowboardåkning. Olika användningsmöjligheter under ytterligare information.",
     :en
   ...
   {:description
    {:fi
     ...
     :se
     "Is-, keramik- eller plastspår. K-punkt samt sommar- och vinteranvändning under ytterligare information. Minimikrav: en liten backe med k-punkt på 75 m eller mera.",
     :en
   ...
   {:description
    {:fi
     ...
     :se
     "Mångsidig badinrättning med rehabiliterings- och rekreationstjänster. Vattenareal samt antal och typ av bassänger under ytterligare information.",
     :en
   ...
   {:description
    {:fi
     ...
     :se
     "Hall med en eller flera simbassänger. Antalet bassänger och vattenareal anges under ytterligare information.",
     :en
   ...
   {:description
    {:fi
     ...
     :se
     "Tjänster för båtfarare. Precisering under ytterligare information.",
   ...
   {:description
    {:fi "Petanque-peliin tarkoitettu halli.",
     :se
     "Hall avsedd för petanque. Storlek, antalet planer och utrustning under ytterligare information.",
   ...
   {:description
    {:fi
     ...
     :se
     "En informationnspunkt är en extra informationn vid en friluftsled, ett rekreationsområde eller en annan idrottsplats. På platsen kan det till exempel finnas en informationnstavla och karta eller en mer omfattande servicestation. informationnspunkt-markeringen kan också användas för att ange startpunkten för en rutt.",
     :en
    ...
    :name {:fi "Opastuspiste", :se "informationnspunkt", :en "Info"},
    :type-code 207,
    :main-category 0,
    :status "active",
    :sub-category 2,
   ...
   {:description
    {:fi
     ...
     :se
     "Hall i första hand avsedd för innebandy. Antalet planer samt ytmaterial under ytterligare information.",
     :en
    ...
    {:height-m {:priority 90, :derivable? true},
     ...
     :free-use? {:priority 40},
     :field-length-m {:priority 90, :derivable? true},
     :badminton-courts-count {:priority 80},
     :may-be-shown-in-harrastuspassi-fi? {:priority 0},
     :toilet? {:priority 70},
     :area-m2 {:priority 90, :derivable? true},
     :field-width-m {:priority 90, :derivable? true},
     :scoreboard? {:priority 70},
     :floorball-fields-count {:priority 80, :derivable? true},
     :auxiliary-training-area? {:priority 80},
     :customer-service-point? {:priority 70},
     :school-use? {:priority 40}}},
   2510
   {:description
    {:fi
     ...
     :se
     "Antalet planer och omklädningshytter, uppvärmning osv anges under ytterligare information.",
     :en
   ...
   {:description
    {:fi
     ...
     :se
     "Övningsutrymme byggt för golf. Storlek under ytterligare information.",
     :en
   ...
   {:description
    {:fi
     ...
     :se
     "En eller flera padelbanor inomhus. Ytmaterial konstgräs (med sand), 20 x 10 m. Väggar måste uppfylla spelets krav. Höjd anges under ytterligare information.",
     :en
   ...
   {:description
    {:fi
     ...
     :se
     "Plan avsedd för bollspel. Underlaget består av sand, konstgräs med sand eller liknande. Storleken kan variera. En eller flera bollspelsgrenar är möjliga.",
     :en
   ...
   {:description
    {:fi
     ...
     :se
     "Led avsedd för skidåkning. Ej sommaranvändning och -underhåll. Åkstilar anges under ytterligare information.",
     :en
