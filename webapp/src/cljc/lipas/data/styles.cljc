...
(def temp-symbols
  {1530 {:type-code 1530, :fill "#78fefe", :stroke "#000000"},
   1520 {:type-code 1520, :fill "#c2fef0", :stroke "#707172"},
   ...
   7000 {:type-code 7000, :fill "#e3dabb", :stroke "#000000"},
   ...
   4422 {:type-code 4422, :fill "", :stroke "#de1bad"},
   4430 {:type-code 4430, :fill "", :stroke "#fb7d20"},
   ...
   3120 {:type-code 3120, :fill "#96bffe", :stroke "#000000"},
   104  {:type-code 104, :fill "#39db3e", :stroke "#000000"},
   2330 {:type-code 2330, :fill "#aed301", :stroke "#000000"},
   ...
   2230 {:type-code 2230, :fill "#009500", :stroke "#ff5500"},
   1350 {:type-code 1350, :fill "#00c100", :stroke "#ff5500"},
   ...
   1170 {:type-code 1170, :fill "#778354", :stroke "#000000"},
   4404 {:type-code 4404, :fill "", :stroke "#58c510"},
   108  {:type-code 108, :fill "#99d18f", :stroke "#000000"},
   4401 {:type-code 4401, :fill "", :stroke "#ff0000"},
   2350 {:type-code 2350, :fill "#ff77ab", :stroke "#000000"},
   2340 {:type-code 2340, :fill "#8c2909", :stroke "#000000"},
   ...
   1550 {:type-code 1550, :fill "#3f06d2", :stroke "#ffffff"},
   3230 {:type-code 3230, :fill "#6b84e7", :stroke "#000000"},
   ...
   4510 {:type-code 4510, :fill "#fbb555", :stroke "#000000"},
   4240 {:type-code 4240, :fill "#55007f", :stroke "#000000"},
   2270 {:type-code 2270, :fill "#52c58b", :stroke "#000000"},
   4210 {:type-code 4210, :fill "#d6a9fe", :stroke "#000000"},
   301  {:type-code 301, :fill "#59ac22", :stroke "#004800"},
   ...
   1540 {:type-code 1540, :fill "#03c0ad", :stroke "#000000"},
   ...
   1150 {:type-code 1150, :fill "#637666", :stroke "#000000"},
   2310 {:type-code 2310, :fill "#db5311", :stroke "#000000"},
   ...
   1140 {:type-code 1140, :fill "#547a5a", :stroke "#000000"},
   ...
   1120 {:type-code 1120, :fill "#b0ccb9", :stroke "#c7a481"},
   ...
   1310 {:type-code 1310, :fill "#f07800", :stroke "#000000"},
   ...
   3220 {:type-code 3220, :fill "#2b2fe3", :stroke "#000000"},
   ...
   3130 {:type-code 3130, :fill "#0065d5", :stroke "#000000"},
   3110 {:type-code 3110, :fill "#009ad5", :stroke "#000000"},
   ...
   2260 {:type-code 2260, :fill "#c67392", :stroke "#000000"},
   1160 {:type-code 1160, :fill "#91a745", :stroke "#000000"},
   1210 {:type-code 1210, :fill "#d85b10", :stroke "#000000"},
   5140 {:type-code 5140, :fill "#c57682", :stroke "#00557f"},
   4310 {:type-code 4310, :fill "#b19ae2", :stroke "#000000"},
   207  {:type-code 207, :fill "#fa0c05", :stroke "#000000"},
   1130 {:type-code 1130, :fill "#7daf78", :stroke "#000000"},
   ...
   4402 {:type-code 4402, :fill "", :stroke "#49d6fe"}})
