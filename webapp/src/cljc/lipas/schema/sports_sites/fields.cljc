...
(def field-name (m/schema [:string {:min 2 :max 100}]))
(def lighting-lux (m/schema [:int {:min 0 :max 10000}]))
(def capacity-person (m/schema [:int {:min 0 :max 100000}]))
(def field-length-m (m/schema [:and common/number [:fn #(<= 0 % 200)]]))
(def field-width-m (m/schema [:and common/number [:fn #(<= 0 % 200)]]))
(def field-surface-area-m2 (m/schema [:and common/number [:fn #(<= 0 % 20000)]]))
(def safety-area-m (m/schema [:and common/number [:fn #(<= 0 % 10)]]))
