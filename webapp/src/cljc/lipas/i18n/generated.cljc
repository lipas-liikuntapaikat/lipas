...
(def dicts
 ...
 {:sport
  ...
  :home-page {:description "Hallien vertailu", :headline "Etusivu"},
  :ice-energy
  {:description
 ...
 {:confirm
  {:no "Nej",
   :press-again-to-delete "Använder du Lipas-data?",
   :yes "Ja"},
  :lipas.swimming-pool.saunas
  {:accessible? "Bastu",
  ...
  :lipas.ice-stadium.ventilation
  {:heat-pump-type "Gatuadress", :heat-recovery-efficiency "Kommun"},
  :swim
  {:entering-energy-data "Energi information",
   :headline "Simhallsportal",
   :updating-basic-data "Datum"},
  :filtering-methods
  {:coal "kol",
   :membrane-filtration "Annat",
   :other "Annat",
   :pressure-sand "Färdig"},
  :open-data
  {:description "Fond",
   :headline "Öppen data",
   :rest "REST",
  ...
  {:private-foundation "Privat / fond",
   ...
   :other "Annat",
   :city-technical-services "Privat / organisation",
   :city-sports "Annat",
   :state "Stat"},
  :general
  {:hall "Hall",
  ...
  {:description "Timme",
   ...
   :suh-link "Under en timme sedan",
   :ukty-link "Länge sedan"},
  :time
  ...
  {:sep "September",
   ...
   :dec "December",
   :aug "Augusti"},
  :type {:name "gånger per dag", :type-code "gånger per vecka"},
  :duration
  {:hour "timmar", :month "månader", :years "år", :years-short "år"},
  :lipas.admin
  {:headline "Admin",
   :magic-link "Användaren",
   :send-magic-link "Byggnad",
   :users "Användaren"},
  :lipas.building
  {:headline "Byggnad",
   :main-designers "Antalet personal",
   :staff-count "Antalet personal",
   :total-volume-m3 "Kommentar"},
  :search
  {:display-closest-first "Sök...",
   :headline "Sök",
   :page-size "Sök",
   :pagination "Sök mera...",
   :placeholder "Sök...",
   :school-use-filter "Betong",
   :search "Sök",
   :search-more "Sök mera..."},
  :map.tools
  {:drawing-tooltip "Jyväskylä universitet",
   :drawing-hole-tooltip "Huvudmeny",
   :importing-tooltip "April",
   :deleting-tooltip "Augusti",
   :splitting-tooltip "December"},
  :partners {:headline "mm"},
  :actions
  {:select-year "Välj år",
   :select-owners "Välj ägarna",
   :select-admins "Välj administratörer",
   :save-draft "Välj kommuner",
   ...
   :select-statuses "Välj år",
   :select-cities "Välj kommuner",
   :select-hint "Välj...",
   :discard "Anulera",
   :more "Öppna huvudmenyn",
   :cancel "Avbryt",
   :select-columns "Välj ägarna",
   :add "Tillägg ",
  ...
  :login
  {:headline "Logga in",
   :login-here "Logga in med lösenord",
   :login-with-password "Logga in med lösenord",
   :password "Lösenord",
   :logout "Logga ut",
   :username "E-post / användarnamn",
   :login-help "Logga in med epost",
   :login "Logga in",
   :order-magic-link "E-post / användarnamn",
   :login-with-magic-link "Logga in med epost",
   :bad-credentials "Logga in",
   :magic-link-ordered "Lösenord",
   :username-example "paavo.paivittaja@kunta.fi",
   :forgot-password? "Glömt lösenordet?"},
  :notifications {:get-failed "Kommun", :save-success "Företag"},
  :lipas.swimming-pool.energy-saving
  {:filter-rinse-water-heat-recovery? "Gym"},
  :ice-form {:headline-short "El", :select-rink "Bensin"},
  :restricted {:login-or-register "Logga in eller registrera dig"},
  :lipas.sports-site
  {:delete-tooltip "Ta bort motionsplats...",
   :headline "Namn på finska",
   ...
   :type "Typ",
   :delete "Ta bort {1}",
   :renovation-years "Typ",
   :name-localized-se "Namn på svenska",
   :status "Web-sida",
   :id "LIPAS-ID",
   :comment "Ta bort {1}",
   :name-short "Namn",
   :delete-reason "Epost (publik)",
   :email-public "Epost (publik)",
   :contact "Ta bort motionsplats...",
   :owner "Ägare",
   :marketing-name "Namn"},
  :status
  {:incorrect-data "Fel information",
   :out-of-service-permanently "Berg",
   :out-of-service-temporarily "Stål"},
  :register {:headline "Registrera"},
  :map.address-search {:title "Sök address", :tooltip "Sök address"},
  :lipas.visitors {:total-count "Glömt lösenordet?"},
  :lipas.energy-stats
  ...
  :lipas.swimming-pool.pools
  {:add-pool "Tillsätt en pool", :headline "Tillsätt en bastu"},
  :condensate-energy-targets {:track-heating "Nej"},
  :refrigerants
  {:CO2 "CO2 (koldioxid)",
   :R134A "R134A",
   :R22 "R22",
  ...
  {:contacts "Kontaktuppgifter",
   :select-fields "Glömt lösenordet?",
   :shortcuts "Lösenordet måste innehålle minst 6 tecken."},
  :map.import {:unknown-format "LIPAS"},
  :error
  {:email-conflict "Ingen information",
   :no-data "Ingen information",
   :reset-token-expired "Användarnamnet är redan i användning",
   :user-not-found "Användare hittas ej",
   :username-conflict "Användarnamnet är redan i användning"},
  :reminders
  {:after-one-month "Välj datum",
   :description "Imorgon",
  ...
  :sauna-types {:infrared-sauna "Sök", :sauna "Bastu"},
  :stats-metrics {:operating-incomes "Tegel", :subsidies "Betong"},
  :refrigerant-solutions
  {:CO2 "CO2",
   :H2ONH3 "H2O/NH3",
   :cacl "CaCl",
   :ethanol-water "R404A",
   :ethylene-glycol "R407A",
   :freezium "Freezium",
   :water-glycol "R717"},
  :user
  {:greeting "Simhallsportal",
   :headline "Mitt konto",
  ...
  {:brick "Tegel",
   ...
   :wood "Träd"},
  :stats
  {:length-km-sum "Region",
   :select-years "Välj åren",
   :select-city "Välj kommun",
   :age-structure-stats "Byggnadsår",
   :subsidies-count "Fel information",
   :select-city-service "Välj åren",
   :region "Region",
   :length-km-avg "Välj kommuner",
   :length-km-min "Välj kommun",
   :select-cities "Välj kommuner"},
  :pool-structures
  {:concrete "Betong",
   :hardened-plastic "Allaktivitetsbassäng",
   :steel "Stål"},
  :map
  {:zoom-to-user "Sök address",
   :remove "Ta bort",
   :modify-polygon "Ta bort rutten",
   :draw-polygon "Tillsätt område",
   :center-map-to-site "Ladda GPX",
   :draw-hole "Tillsätt hål",
   :remove-polygon "Ta bort området",
   :modify-linestring "Ta bort",
   :download-gpx "Ladda GPX",
   :add-to-map "Tillsätt till kartan",
   :remove-linestring "Ta bort rutten",
   :draw-geoms "Rita",
   :draw "Tillsätt område",
   :draw-linestring "Tillsätt rutt",
   :zoom-to-site "Sök address"},
  :supporting-structures
  {:brick "Tegel",
   :concrete "Betong",
   :solid-rock "Berg",
  ...
  {:unknown "Ingen information",
   ...
   :city "Kommun",
   :state "Stat",
   :registered-association "m",
   :foundation "Fond",
   :city-main-owner "Ingen information"},
  :menu
  {:frontpage "Februari",
   :headline "LIPAS",
   ...
   :main-menu "Huvudmeny"},
  :dryer-types
  {:cooling-coil "timmar", :munters "månader", :none "år"},
  :physical-units
  {:mm "mm",
   :hour "h",
   :m3 "m³",
   ...
   :celsius "°C"},
  :lipas.swimming-pool.water-treatment
  {:headline "Kontaktuppgifter", :uv-treatment? "E-post"},
  :statuses {:edited "Träd"},
  :lipas.user
  {:email "E-post",
   :saved-searches "Användarnamn",
   :password "Lösenord",
   :lastname "Efternamn",
   :sports-sites "tane12",
