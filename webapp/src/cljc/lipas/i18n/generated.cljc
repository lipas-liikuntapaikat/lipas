...
(def dicts
 ...
 {:sport
  {:description
   ...
   :legacy-disclaimer
   "Sports sites are not here yet but they can be  accessed through existing LIPAS by clicking the link below.",
  ...
  {:table-view "Table view",
   ...
   :page-size "Page size",
   :search "Search...",
   :permissions-filter "Show only sites I can edit",
  ...
  {:remove "Remove",
   ...
   :draw-geoms "Draw",
   :confirm-remove
   "Are you sure you want to delete chosen geometry?",
   :draw "Draw",
 ...
 {:confirm {:no "Nej", :yes "Ja"},
  :lipas.swimming-pool.saunas
  {:headline "Bastu", :men? "Män", :women? "Kvinnor"},
  ...
  :filtering-methods {:coal "kol"},
  :open-data {:rest "REST", :wms-wfs "WMS & WFS"},
  :pool-types
  ...
  :admin {:municipal-consortium "Samkommun"},
  :general
  {:comment "Kommentar",
   :done "Färdig",
   :name "Namn",
  ...
  :swim-energy {:headline-short "Info"},
  :time
  ...
  :lipas.building {:headline "Byggnad"},
  :search {:headline "Sök"},
  :actions
  {:close "Stäng",
   :delete "Radera",
  ...
  :units {:pcs "st", :percent "%", :person "pers"},
  :lipas.energy-consumption {:comment "Kommentar"},
  :lipas.location
  {:address "Gatuadress",
   :city "Kommun",
  ...
  :ceiling-structures
  {:concrete "Betong", :glass "Glas", :steel "Stål", :wood "Träd"},
  :lipas.swimming-pool.facilities
  {:gym? "Gym", :kiosk? "Kiosk / café"},
  ...
  {:CO2 "CO2",
   ...
   :cacl "CaCl",
   :freezium "Freezium"},
  :user {:ice-stadiums-link "Ishallsportal"},
  :building-materials
  {:brick "Tegel", :concrete "Betong", :steel "Stål", :wood "Träd"},
  ...
  :menu {:headline "LIPAS", :jyu "Jyväskylä universitet"},
  :physical-units
  {:mm "mm",
   :hour "h",
   :m3 "m³",
