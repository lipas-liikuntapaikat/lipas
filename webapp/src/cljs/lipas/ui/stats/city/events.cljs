...
(rf/reg-event-fx ::create-finance-report
  (fn [{:keys [db]} _]
...
(rf/reg-event-db ::finance-report-success
  (fn [db [_ data]]
...
(rf/reg-event-fx ::download-finance-excel
