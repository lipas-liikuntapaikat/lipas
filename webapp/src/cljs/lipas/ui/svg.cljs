...
(defn github-icon "Copied from https://bit.ly/2HBcWtU"
  []
...
(defn ->school-str [{:keys [color width height hover?]
                     :or   {color "blue" width 24 height 24 hover? false}}]
  (let [fill (if hover? "rgba(199, 201, 200, 0.8)" "none")]
